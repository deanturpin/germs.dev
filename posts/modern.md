...
## Inline keyword
Just let the compiler decide what should be inlined. It will probably ignore
you anyway.

## Move semantics
This is a biggie that you exploit just by moving to C++11 and beyond. The
compiler can now choose to move data where previously it would have copied it,
potentially giving huge performance benefits.
